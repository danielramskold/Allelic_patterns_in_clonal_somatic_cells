...
def rpkmfile_merge(allelehits_files, outputpath):
	subprocess.call(['python', '/mnt/crick/danielr/pythonbase/merge_rpkmforgenes_output.py', outputpath]+allelehits_files)
...
if '__main__' == __name__:
	...
	parser.add_argument('--folder_scheme', choices=['sample/sample_unique.bam', 'sample/rnastar/sample.bam'], default='sample/sample_unique.bam')
	o = parser.parse_args()
